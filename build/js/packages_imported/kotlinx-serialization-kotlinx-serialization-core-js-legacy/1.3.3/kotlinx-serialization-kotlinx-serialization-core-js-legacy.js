(function (root, factory) {
  ...
  function EncodeDefault$Mode$valueOf(name) {
    switch (name) {
      ...
      default:
        throwISE('No enum constant kotlinx.serialization.EncodeDefault.Mode.' + name);
    }
  }
  ...
  function serialDescriptor_0(type) {
    return serializer_15(type).descriptor;
  }
  ...
  var decodeStructure = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.encoding.decodeStructure_tzrhxq$', function ($receiver, descriptor, block) {
  ...
  var encodeStructure = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.encoding.encodeStructure_iqdhfr$', function ($receiver, descriptor, block) {
    var composite = $receiver.beginStructure_24f42q$(descriptor);
    block(composite);
    composite.endStructure_24f42q$(descriptor);
  });
  var encodeCollection = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.encoding.encodeCollection_mcp0x$', function ($receiver, descriptor, collectionSize, block) {
    var composite = $receiver.beginCollection_szpzho$(descriptor, collectionSize);
    block(composite);
    composite.endStructure_24f42q$(descriptor);
  });
  var encodeCollection_0 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.encoding.encodeCollection_z7tnzi$', wrapFunction(function () {
    ...
    return function ($receiver, descriptor, collection, block) {
      var composite = $receiver.beginCollection_szpzho$(descriptor, collection.size);
      encodeCollection$lambda(collection, block)(composite);
      composite.endStructure_24f42q$(descriptor);
    };
  }));
  ...
  PrimitiveArraySerializer.$metadata$ = {
    ...
    interfaces: [CollectionLikeSerializer]
  };
  ...
  ArrayListSerializer.$metadata$ = {
    ...
    interfaces: [CollectionSerializer]
  };
  ...
  function ObjectSerializer(serialName, objectInstance) {
    ...
    this.descriptor_uhy216$_0 = lazy_0(LazyThreadSafetyMode.PUBLICATION, ObjectSerializer$descriptor$lambda(serialName, this));
  }
  ...
  function PluginGeneratedSerialDescriptor(serialName, generatedSerializer, elementsCount) {
    ...
    this.childSerializers_am32qy$_0 = lazy_0(LazyThreadSafetyMode.PUBLICATION, PluginGeneratedSerialDescriptor$childSerializers$lambda(this));
    this.typeParameterDescriptors_8be2vx$_tf62pe$_0 = lazy_0(LazyThreadSafetyMode.PUBLICATION, PluginGeneratedSerialDescriptor$typeParameterDescriptors$lambda(this));
    this._hashCode_61j445$_0 = lazy_0(LazyThreadSafetyMode.PUBLICATION, PluginGeneratedSerialDescriptor$_hashCode$lambda(this));
  }
  ...
  SerializersModuleBuilder.prototype.registerDefaultPolymorphicSerializer_mv4x8a$ = function (baseClass, defaultSerializerProvider, allowOverwrite) {
    var previous = this.polyBase2DefaultSerializerProvider_0.get_11rb$(baseClass);
    if (previous != null && !equals(previous, defaultSerializerProvider) && !allowOverwrite) {
      throw IllegalArgumentException_init('Default serializers provider for ' + baseClass + ' is already registered: ' + toString(previous));
    }
  ...
  SerializersModuleBuilder.prototype.registerDefaultPolymorphicDeserializer_b3da2m$ = function (baseClass, defaultDeserializerProvider, allowOverwrite) {
    ...
    if (previous != null && !equals(previous, defaultDeserializerProvider) && !allowOverwrite) {
      throw IllegalArgumentException_init('Default deserializers provider for ' + baseClass + ' is already registered: ' + toString(previous));
    }
  ...
  function PolymorphicSerializer(baseClass) {
    ...
    this._annotations_0 = emptyList();
    this.descriptor_nog3ww$_0 = lazy_0(LazyThreadSafetyMode.PUBLICATION, PolymorphicSerializer$descriptor$lambda(this));
  }
  ...
  function SealedClassSerializer(serialName, baseClass, subclasses, subclassSerializers) {
    ...
    this._annotations_0 = emptyList();
    this.descriptor_gganzq$_0 = lazy_0(LazyThreadSafetyMode.PUBLICATION, SealedClassSerializer$descriptor$lambda(serialName, this, subclassSerializers));
  ...
  var serializer_13 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.serializer_287e2$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var serializer = _.kotlinx.serialization.serializer_saj79j$;
    var KSerializer = _.kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
  ...
  var serializer_14 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.serializer_3pytt4$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var serializer = _.kotlinx.serialization.serializer_ca95z9$;
    var KSerializer = _.kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
  ...
  package$serialization.serializer_1yb8b7$ = serializer_17;

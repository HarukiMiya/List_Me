(function (root, factory) {
  ...
  var StringValuesSingleImpl = $module$ktor_ktor_utils_js_legacy.io.ktor.util.StringValuesSingleImpl;
  ...
  var contains_0 = $module$ktor_ktor_utils_js_legacy.io.ktor.util.contains_9p7nab$;
  ...
  ParseException.prototype = Object.create(IllegalArgumentException.prototype);
  ...
  function CacheControl$Visibility(name, ordinal, headerValue) {
    Enum.call(this);
    this.headerValue_8be2vx$ = headerValue;
    this.name$ = name;
  ...
  function CacheControl$Visibility_initFields() {
    ...
    CacheControl$Visibility$Public_instance = new CacheControl$Visibility('Public', 0, 'public');
    CacheControl$Visibility$Private_instance = new CacheControl$Visibility('Private', 1, 'private');
  }
  ...
  CacheControl$NoCache.prototype.toString = function () {
    if (this.visibility == null) {
      ...
      return 'no-cache, ' + this.visibility.headerValue_8be2vx$;
    }
  };
  CacheControl$NoCache.prototype.equals = function (other) {
    return Kotlin.isType(other, CacheControl$NoCache) && equals(this.visibility, other.visibility);
  };
  CacheControl$NoCache.prototype.hashCode = function () {
    var $receiver = this.visibility;
    var tmp$;
  ...
  CacheControl$NoStore.prototype.toString = function () {
    if (this.visibility == null) {
      ...
      return 'no-store, ' + this.visibility.headerValue_8be2vx$;
    }
  };
  CacheControl$NoStore.prototype.equals = function (other) {
    return Kotlin.isType(other, CacheControl$NoStore) && equals(other.visibility, this.visibility);
  };
  CacheControl$NoStore.prototype.hashCode = function () {
    var $receiver = this.visibility;
    var tmp$;
    return (tmp$ = $receiver != null ? hashCode($receiver) : null) != null ? tmp$ : 0;
  };
  ...
  CacheControl$MaxAge.prototype.toString = function () {
    ...
    if (this.visibility != null) {
      parts.add_11rb$(this.visibility.headerValue_8be2vx$);
    }
    return joinToString(parts, ', ');
  };
  CacheControl$MaxAge.prototype.equals = function (other) {
    return other === this || (Kotlin.isType(other, CacheControl$MaxAge) && other.maxAgeSeconds === this.maxAgeSeconds && other.proxyMaxAgeSeconds == this.proxyMaxAgeSeconds && other.mustRevalidate === this.mustRevalidate && other.proxyRevalidate === this.proxyRevalidate && equals(other.visibility, this.visibility));
  };
  CacheControl$MaxAge.prototype.hashCode = function () {
    var tmp$;
    var result = this.maxAgeSeconds;
    result = (31 * result | 0) + ((tmp$ = this.proxyMaxAgeSeconds) != null ? tmp$ : 0) | 0;
    result = (31 * result | 0) + hashCode(this.mustRevalidate) | 0;
    result = (31 * result | 0) + hashCode(this.proxyRevalidate) | 0;
    var tmp$_0 = 31 * result | 0;
    var $receiver = this.visibility;
    var tmp$_1;
    result = tmp$_0 + ((tmp$_1 = $receiver != null ? hashCode($receiver) : null) != null ? tmp$_1 : 0) | 0;
    return result;
  };
  ...
  function encodeURLQueryComponent$lambda$lambda(closure$spaceToPlus, this$, closure$encodeFull) {
    return function (it) {
      if (it === toByte(32))
        ...
        this$.append_pdl1vj$(percentEncode(it));
      return Unit;
    };
  }
  ...
  function percentEncode($receiver) {
    var $receiver_0 = StringBuilder_init(3);
    var code = $receiver & 255;
    $receiver_0.append_s8itvh$(37);
    $receiver_0.append_s8itvh$(hexDigitToChar(code >> 4));
    $receiver_0.append_s8itvh$(hexDigitToChar(code & 15));
    return $receiver_0.toString();
  }
  ...
  ContentType.prototype.match_9v5yzd$ = function (pattern) {
    ...
    loop_label: while (tmp$.hasNext()) {
      var tmp$_1 = tmp$.next();
      var patternName = tmp$_1.component1()
      , patternValue = tmp$_1.component2();
  ...
  Object.defineProperty(StringLexer.prototype, 'hasRemaining', {
    configurable: true,
    get: function () {
  ...
  StringLexer.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'StringLexer',
    interfaces: []
  };
  ...
  var otherwise = defineInlineFunction('ktor-ktor-http-js-legacy.io.ktor.http.otherwise_xf59e$', function ($receiver, block) {
    if (!$receiver)
      block();
  });
  var tryParseTime = defineInlineFunction('ktor-ktor-http-js-legacy.io.ktor.http.tryParseTime_ndhspt$', wrapFunction(function () {
    var StringLexer_init = _.io.ktor.http.StringLexer;
    var unboxChar = Kotlin.unboxChar;
    var isDigit = _.io.ktor.http.isDigit_nupfqh$;
    var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
    var isNonDigit = _.io.ktor.http.isNonDigit_nupfqh$;
    var isOctet = _.io.ktor.http.isOctet_nupfqh$;
    function tryParseTime$lambda$lambda(it) {
      return isDigit(unboxChar(it));
    }
    function tryParseTime$lambda$lambda_0(it) {
    ...
    return function ($receiver, success) {
      var lexer = new StringLexer_init($receiver);
  ...
  var tryParseMonth = defineInlineFunction('ktor-ktor-http-js-legacy.io.ktor.http.tryParseMonth_gw2jwt$', wrapFunction(function () {
    var Month$values = _.$$importsForInline$$['ktor-ktor-utils-js-legacy'].io.ktor.util.date.Month.values;
    var startsWith = Kotlin.kotlin.text.startsWith_7epoxm$;
    return function ($receiver, success) {
      var tmp$, tmp$_0;
      ...
      for (tmp$_0 = 0; tmp$_0 !== tmp$.length; ++tmp$_0) {
        ...
        if (startsWith($receiver, month.value, true)) {
          success(month);
          return;
        }
      }
  ...
  var tryParseDayOfMonth = defineInlineFunction('ktor-ktor-http-js-legacy.io.ktor.http.tryParseDayOfMonth_j48bfd$', wrapFunction(function () {
    var StringLexer_init = _.io.ktor.http.StringLexer;
    var unboxChar = Kotlin.unboxChar;
    var isDigit = _.io.ktor.http.isDigit_nupfqh$;
    var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
    ...
    return function ($receiver, success) {
      var lexer = new StringLexer_init($receiver);
      var start = lexer.index;
      if (!lexer.accept_akknk2$(tryParseDayOfMonth$lambda$lambda)) {
        return;
      }
      lexer.accept_akknk2$(tryParseDayOfMonth$lambda$lambda_0);
      var $receiver_0 = lexer.source;
      var endIndex = lexer.index;
      var day = toInt($receiver_0.substring(start, endIndex));
      if (lexer.accept_akknk2$(tryParseDayOfMonth$lambda)) {
        lexer.acceptWhile_akknk2$(tryParseDayOfMonth$lambda_0);
      }
      success(day);
    };
  }));
  var tryParseYear = defineInlineFunction('ktor-ktor-http-js-legacy.io.ktor.http.tryParseYear_j48bfd$', wrapFunction(function () {
    var StringLexer_init = _.io.ktor.http.StringLexer;
    var unboxChar = Kotlin.unboxChar;
    var isDigit = _.io.ktor.http.isDigit_nupfqh$;
    var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
    ...
    return function ($receiver, success) {
      ...
      for (var index = 0; index < 2; index++) {
        if (!lexer.accept_akknk2$(tryParseYear$lambda$lambda$lambda)) {
          return;
        }
      }
      for (var index_0 = 0; index_0 < 2; index_0++) {
        lexer.accept_akknk2$(tryParseYear$lambda$lambda$lambda_0);
      }
      var $receiver_0 = lexer.source;
      var endIndex = lexer.index;
      var year = toInt($receiver_0.substring(start, endIndex));
      if (lexer.accept_akknk2$(tryParseYear$lambda)) {
        lexer.acceptWhile_akknk2$(tryParseYear$lambda_0);
      }
      success(year);
    };
  }));
  ...
  CookieDateParser.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CookieDateParser',
    interfaces: []
  };
  ...
  CookieDateBuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CookieDateBuilder',
    interfaces: []
  };
  ...
  InvalidCookieDateException.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'InvalidCookieDateException',
  ...
  function fromFileExtension($receiver, ext) {
    var current = toLowerCasePreservingASCIIRules(removePrefix(ext, '.'));
    while (current.length > 0) {
      var type = get_contentTypesByExtensions().get_11rb$(current);
      if (type != null) {
        return type;
      }
  ...
  function fileExtensions($receiver) {
    var tmp$, tmp$_0;
    return (tmp$_0 = (tmp$ = get_extensionsByContentType().get_11rb$($receiver)) != null ? tmp$ : get_extensionsByContentType().get_11rb$($receiver.withoutParameters())) != null ? tmp$_0 : emptyList();
  }
  ...
  function get_contentTypesByExtensions() {
    return contentTypesByExtensions.value;
  }
  function extensionsByContentType$lambda$lambda(f) {
    var first = f.component1()
    , second = f.component2();
  ...
  function get_extensionsByContentType() {
    return extensionsByContentType.value;
  }
  function selectDefault($receiver) {
    ...
    if (equals(contentType.contentType, 'text') && charset(contentType) == null)
      tmp$_0 = withCharset(contentType, charsets.Charsets.UTF_8);
    else
      tmp$_0 = contentType;
    return tmp$_0;
  }
  ...
  function escapeIfNeededTo($receiver, out) {
    if (checkNeedEscape($receiver))
      out.append_pdl1vj$(quote($receiver));
    else
      out.append_pdl1vj$($receiver);
  }
  ...
  HeadersBuilder.$metadata$ = {
    ...
    interfaces: [StringValuesBuilderImpl]
  };
  ...
  function parseAndSortContentTypeHeader(header) {
    return sortedWith(parseHeaderValue(header), new Comparator(thenByDescending$lambda(new Comparator(thenBy$lambda(new Comparator(compareByDescending$lambda_0(parseAndSortContentTypeHeader$lambda)), parseAndSortContentTypeHeader$lambda_0)), parseAndSortContentTypeHeader$lambda_1)));
  }
    ...
    while (position <= get_lastIndex_0(text)) {
      switch (text.charCodeAt(position)) {
        case 61:
          ...
          var paramEnd = tmp$.component1()
          , paramValue = tmp$.component2();
  ...
  var get_ExceptionFailed = defineInlineFunction('ktor-ktor-http-js-legacy.io.ktor.http.get_ExceptionFailed_i80ybi$', function ($receiver) {
  ...
  function parseUrlEncodedParameters($receiver, defaultEncoding, limit) {
    ...
    var $receiver_1 = ParametersBuilder_0();
    var tmp$_3;
    tmp$_3 = parameters.iterator();
    while (tmp$_3.hasNext()) {
      var element_0 = tmp$_3.next();
      var key = element_0.component1()
      , value = element_0.component2();
  ...
  ParametersBuilderImpl.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ParametersBuilderImpl',
    interfaces: [ParametersBuilder, StringValuesBuilderImpl]
  };
  ...
  function parametersOf_2(map) {
    return new ParametersImpl(map);
  }
  function parametersOf_3(pairs) {
  ...
  function RangeUnits(name, ordinal, unitToken) {
    Enum.call(this);
  ...
  function RangeUnits_initFields() {
    ...
    RangeUnits$Bytes_instance = new RangeUnits('Bytes', 0, 'bytes');
    RangeUnits$None_instance = new RangeUnits('None', 1, 'none');
  }
  ...
  function parseRangesSpecifier(rangeSpec) {
    try {
      ...
      var tmp$_1 = tmp$;
      var unit = tmp$_1.component1()
      , allRangesString = tmp$_1.component2();
      ...
      while (tmp$_2.hasNext()) {
        ...
        if (startsWith(item, '-')) {
          ...
          var tmp$_5 = tmp$_4;
          var from = tmp$_5.component1()
          , to_0 = tmp$_5.component2();
          if (to_0.length > 0) {
  ...
  function toLongRanges($receiver, contentLength) {
    ...
    while (tmp$.hasNext()) {
      ...
      if (Kotlin.isType(item, ContentRange$Bounded)) {
        ...
        transform$result = until(coerceAtLeast_0(contentLength.subtract(item.lastCount), L0), contentLength);
      } else {
  ...
  function mergeRangesKeepOrder($receiver) {
    var tmp$;
    var $receiver_0 = sortedWith($receiver, new Comparator(compareBy$lambda(mergeRangesKeepOrder$lambda)));
    var tmp$_0;
  ...
  RangesSpecifier.prototype.mergeToSingle_s8cxhz$ = function (length) {
    ...
    minByOrNull$break: do {
     ...
     while (false);
    var start = ensureNotNull(minByOrNull$result).start;
    ...
    maxByOrNull$break: do {
     ...
     while (false);
    var endInclusive = coerceAtMost(ensureNotNull(maxByOrNull$result).endInclusive, length.subtract(Kotlin.Long.fromInt(1)));
  ...
  function URLBuilder(protocol, host, port, user, password, pathSegments, parameters, fragment, trailingQuery) {
    ...
    while (tmp$.hasNext()) {
      var item = tmp$.next();
      destination.add_11rb$(encodeURLPath(item));
    }
  ...
  Object.defineProperty(URLBuilder.prototype, 'user', {
    configurable: true,
    get: function () {
      var tmp$;
  ...
  Object.defineProperty(URLBuilder.prototype, 'password', {
    configurable: true,
    get: function () {
      var tmp$;
  ...
  Object.defineProperty(URLBuilder.prototype, 'fragment', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(URLBuilder.prototype, 'pathSegments', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(URLBuilder.prototype, 'encodedParameters', {
    configurable: true,
    get: function () {
  ...
  Object.defineProperty(URLBuilder.prototype, 'parameters', {
    configurable: true,
    get: function () {
  ...
  function pathComponents($receiver, components) {
    return appendPathSegments($receiver, toList_0(components));
  }
  function pathComponents_0($receiver, components) {
    return appendPathSegments($receiver, components);
  }
  function appendPathSegments($receiver, segments) {
    var destination = ArrayList_init(collectionSizeOrDefault(segments, 10));
    var tmp$;
    ...
    var encodedSegments = destination;
    appendEncodedPathSegments($receiver, encodedSegments);
    return $receiver;
  }
  function appendPathSegments_0($receiver, components) {
    return appendPathSegments($receiver, toList_0(components));
  }
  function path($receiver, path) {
    $receiver.pathSegments = toList_0(path);
  }
  function appendEncodedPathSegments($receiver, segments) {
    $receiver.encodedPathSegments = plus_0($receiver.encodedPathSegments, segments);
    return $receiver;
  }
  function appendEncodedPathSegments_0($receiver, components) {
    return appendEncodedPathSegments($receiver, toList_0(components));
  }
  ...
  function isLetter($receiver) {
    return (new CharRange(97, 122)).contains_mef7kx$(String.fromCharCode($receiver).toLowerCase().charCodeAt(0));
  }
  ...
  function takeFrom_0($receiver, url) {
    ...
    $receiver.encodedParameters = url.encodedParameters;
  ...
  function get_fullPath($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    appendUrlFullPath($receiver_0, $receiver.encodedPath, $receiver.encodedQuery, $receiver.trailingQuery);
    return $receiver_0.toString();
  }
  function get_hostWithPort($receiver) {
    return $receiver.host + ':' + $receiver.port;
  }
  function appendUrlFullPath($receiver, encodedPath, encodedQuery, trailingQuery) {
    ...
    $receiver.append_gw00v9$(encodedQuery);
  }
  ...
  Object.defineProperty(Url_1.prototype, 'port', {
    configurable: true,
    get: function () {
      var tmp$;
  ...
  Object.defineProperty(Url_1.prototype, 'encodedPath', {
    configurable: true,
    get: function () {
      return this.encodedPath_x8m1ri$_0.value;
    }
  });
  Object.defineProperty(Url_1.prototype, 'encodedQuery', {
    configurable: true,
    get: function () {
      return this.encodedQuery_z7mkln$_0.value;
    }
  });
  Object.defineProperty(Url_1.prototype, 'encodedPathAndQuery', {
    configurable: true,
    get: function () {
      return this.encodedPathAndQuery_qwe3q9$_0.value;
    }
  });
  Object.defineProperty(Url_1.prototype, 'encodedUser', {
    configurable: true,
    get: function () {
      return this.encodedUser_x5jvx0$_0.value;
    }
  });
  Object.defineProperty(Url_1.prototype, 'encodedPassword', {
    configurable: true,
    get: function () {
      return this.encodedPassword_2exfmk$_0.value;
    }
  });
  Object.defineProperty(Url_1.prototype, 'encodedFragment', {
    configurable: true,
    get: function () {
  ...
  function copy($receiver, protocol, host, specifiedPort, encodedPath, parameters, fragment, user, password, trailingQuery) {
    if (protocol === void 0)
      protocol = $receiver.protocol;
    if (host === void 0)
      host = $receiver.host;
    if (specifiedPort === void 0)
      specifiedPort = $receiver.specifiedPort;
    if (encodedPath === void 0)
      encodedPath = $receiver.encodedPath;
    if (parameters === void 0)
    ...
    if (trailingQuery === void 0)
      trailingQuery = $receiver.trailingQuery;
    throw IllegalStateException_init('Please use URLBuilder(url)'.toString());
  }
  ...
  function get_protocolWithAuthority($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    $receiver_0.append_pdl1vj$($receiver.protocol.name);
    $receiver_0.append_pdl1vj$('://');
    $receiver_0.append_pdl1vj$(get_encodedUserAndPassword_0($receiver));
    if ($receiver.specifiedPort === 0 || $receiver.specifiedPort === $receiver.protocol.defaultPort) {
      $receiver_0.append_pdl1vj$($receiver.host);
  ...
  Object.defineProperty(UrlDecodedParametersBuilder.prototype, 'caseInsensitiveName', {
    configurable: true,
    get: function () {
  ...
  UrlDecodedParametersBuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UrlDecodedParametersBuilder',
    interfaces: [ParametersBuilder]
  };
  ...
  function parseAuthorizationHeader(headerValue) {
    ...
    while (index < headerValue.length && isToken(headerValue.charCodeAt(index))) {
      index = index + 1 | 0;
    }
    var authScheme = substring(headerValue, until_0(tokenStartIndex, index));
    index = skipSpaces(headerValue, index);
    ...
    if (headerValue.length === index) {
      return new HttpAuthHeader$Parameterized(authScheme, emptyList());
    }
    var token68 = matchToken68(headerValue, index);
    if (token68 != null) {
      return new HttpAuthHeader$Single(authScheme, token68);
    }
    var parameters = matchParameters(headerValue, tokenStartIndex);
    return HttpAuthHeader$HttpAuthHeader$Parameterized_init(authScheme, parameters);
  }
  function matchParameters(headerValue, startIndex) {
    var result = LinkedHashMap_init_0();
    var index = startIndex;
    while (index > 0 && index < headerValue.length) {
      index = matchParameter(headerValue, index, result);
      index = skipDelimiter(headerValue, index, 44);
    }
    return result;
  }
  function matchParameter(headerValue, startIndex, parameters) {
    ...
    var key = substring(headerValue, until_0(keyStart, index));
    index = skipSpaces(headerValue, index);
    if (index >= headerValue.length || headerValue.charCodeAt(index) !== 61) {
      throw new ParseException("Expected `=` after parameter key '" + key + "': " + headerValue);
    }
    index = index + 1 | 0;
    index = skipSpaces(headerValue, index);
    var quoted = false;
    var valueStart = index;
    if (headerValue.charCodeAt(index) === 34) {
      quoted = true;
      index = index + 1 | 0;
      valueStart = index;
      var escaped = false;
      while (index < headerValue.length && (headerValue.charCodeAt(index) !== 34 || escaped)) {
        escaped = (!escaped && headerValue.charCodeAt(index) === 92);
        index = index + 1 | 0;
      }
      if (index === headerValue.length) {
        throw new ParseException("Expected closing quote'" + '"' + "' in parameter: " + headerValue + ' ');
      }
    } else {
      while (index < headerValue.length && headerValue.charCodeAt(index) !== 32 && headerValue.charCodeAt(index) !== 44) {
        index = index + 1 | 0;
      }
    }
    var value = substring(headerValue, until_0(valueStart, index));
    var value_0 = quoted ? unescaped(value) : value;
    parameters.put_xwzc9p$(key, value_0);
    if (quoted) {
      index = index + 1 | 0;
    }
    return index;
  ...
  function matchToken68(headerValue, startIndex) {
    var index = startIndex;
    while (index < headerValue.length && isToken68(headerValue.charCodeAt(index))) {
      index = index + 1 | 0;
    }
    while (index < headerValue.length && headerValue.charCodeAt(index) === 61) {
      index = index + 1 | 0;
    }
    var $receiver = until_0(index, headerValue.length);
    var all$result;
    all$break: do {
      var tmp$;
      if (Kotlin.isType($receiver, Collection) && $receiver.isEmpty()) {
      ...
      while (tmp$.hasNext()) {
        var element = tmp$.next();
        if (!(headerValue.charCodeAt(element) === 32)) {
          all$result = false;
          break all$break;
        }
      }
     ...
     while (false);
    var onlySpaceRemaining = all$result;
    if (onlySpaceRemaining) {
      return substring(headerValue, until_0(startIndex, index));
    }
    return null;
  }
  function HttpAuthHeader(authScheme) {
    ...
    if (!token68Pattern.matches_6bul2c$($receiver)) {
      throw new ParseException('Invalid authScheme value: it should be token, but instead it is ' + this.authScheme);
    }
  }
  function HttpAuthHeader$Single(authScheme, blob) {
    ...
    if (!token68Pattern.matches_6bul2c$($receiver)) {
      throw new ParseException('Invalid blob value: it should be token68, but instead it is ' + this.blob);
    }
  }
  ...
  function HttpAuthHeader$Parameterized(authScheme, parameters, encoding) {
    ...
    while (tmp$.hasNext()) {
      ...
      if (!token68Pattern.matches_6bul2c$($receiver)) {
        throw new ParseException('parameter name should be a token but it is ' + element.name);
      }
    }
  }
  ...
  HttpAuthHeader$Companion.prototype.basicAuthChallenge_tsx5t5$ = function (realm, charset) {
  ...
  function unescaped$lambda(it) {
    return takeLast(it.value, 1);
  }
  function unescaped($receiver) {
    return escapeRegex.replace_20wsma$($receiver, unescaped$lambda);
  }
  function skipDelimiter($receiver, startIndex, delimiter) {
    var index = skipSpaces($receiver, startIndex);
    while (index < $receiver.length && $receiver.charCodeAt(index) !== delimiter) {
      index = index + 1 | 0;
    }
    if (index === $receiver.length)
      return -1;
    index = index + 1 | 0;
    return skipSpaces($receiver, index);
  }
  function skipSpaces($receiver, startIndex) {
    var index = startIndex;
    while (index < $receiver.length && $receiver.charCodeAt(index) === 32) {
      index = index + 1 | 0;
    }
    return index;
  }
  function isToken68($receiver) {
    return (new CharRange(97, 122)).contains_mef7kx$($receiver) || (new CharRange(65, 90)).contains_mef7kx$($receiver) || isDigit($receiver) || TOKEN68_EXTRA.contains_11rb$(toBoxedChar($receiver));
  }
  function isToken($receiver) {
    return (new CharRange(97, 122)).contains_mef7kx$($receiver) || (new CharRange(65, 90)).contains_mef7kx$($receiver) || isDigit($receiver) || TOKEN_EXTRA.contains_11rb$(toBoxedChar($receiver));
  }
  ...
  Object.defineProperty(ChannelWriterContent.prototype, 'contentType', {
    get: function () {
      return this.contentType_fy767l$_0;
    }
  });
  Object.defineProperty(ChannelWriterContent.prototype, 'status', {
    get: function () {
      return this.status_pq6p26$_0;
    }
  });
  Object.defineProperty(ChannelWriterContent.prototype, 'contentLength', {
    get: function () {
  ...
  ChannelWriterContent.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ChannelWriterContent',
  ...
  PartData$BinaryChannelItem.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'BinaryChannelItem',
    interfaces: [PartData]
  };
  ...
  VersionCheckResult.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'VersionCheckResult',
    interfaces: [Enum]
  };
  ...
  LastModifiedVersion.prototype.check_fkh4uy$ = function (requestHeaders) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    if ((tmp$_0 = (tmp$ = requestHeaders.getAll_61zpoe$(HttpHeaders_getInstance().IfModifiedSince)) != null ? this.parseDates_0(tmp$) : null) != null) {
      if (!this.ifModifiedSince_iwdcyr$(tmp$_0)) {
        return VersionCheckResult$NOT_MODIFIED_getInstance();
      }
    }
    if ((tmp$_2 = (tmp$_1 = requestHeaders.getAll_61zpoe$(HttpHeaders_getInstance().IfUnmodifiedSince)) != null ? this.parseDates_0(tmp$_1) : null) != null) {
      if (!this.ifUnmodifiedSince_iwdcyr$(tmp$_2)) {
        return VersionCheckResult$PRECONDITION_FAILED_getInstance();
      }
    }
    return VersionCheckResult$OK_getInstance();
  ...
  LastModifiedVersion.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LastModifiedVersion',
    interfaces: [Version]
  };
  ...
  EntityTagVersion$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  ...
  EntityTagVersion_0.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'EntityTagVersion',
    interfaces: [Version]
  };
  ...
  GrammarBuilder.prototype.build = function () {
    return this.grammars_0.size === 1 ? first_0(this.grammars_0) : new SequenceGrammar(this.grammars_0);
  };
  ...
  function ParseException(message, cause) {
    ...
    this.message_lu3g1n$_0 = message;
    this.cause_zfq57d$_0 = cause;
    this.name = 'ParseException';
  }
  Object.defineProperty(ParseException.prototype, 'message', {
    get: function () {
      return this.message_lu3g1n$_0;
    }
  });
  Object.defineProperty(ParseException.prototype, 'cause', {
    get: function () {
      return this.cause_zfq57d$_0;
    }
  });
  ...
  var flatten = defineInlineFunction('ktor-ktor-http-js-legacy.io.ktor.http.parsing.flatten_mtaoqd$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var wrapFunction = Kotlin.wrapFunction;
  ...
  function get_origin($receiver) {
    ...
    if (util.PlatformUtils.IS_BROWSER)
      if (window !== undefined) {
        ...
        return typeof (tmp$ = self.location.origin) === 'string' ? tmp$ : throwCCE();
      }
     else
  ...
  $$importsForInline$$['ktor-ktor-http-js-legacy'] = _;
  ...
  package$http.otherwise_xf59e$ = otherwise;
  package$http.tryParseTime_ndhspt$ = tryParseTime;
  $$importsForInline$$['ktor-ktor-utils-js-legacy'] = $module$ktor_ktor_utils_js_legacy;
  package$http.tryParseMonth_gw2jwt$ = tryParseMonth;
  package$http.tryParseDayOfMonth_j48bfd$ = tryParseDayOfMonth;
  package$http.tryParseYear_j48bfd$ = tryParseYear;
  ...
  package$http.charset_c3tjzj$ = charset_0;
  ...
  package$http.parseUrlEncodedParameters_pu7mjb$ = parseUrlEncodedParameters;
  ...
  package$http.formUrlEncodeTo_o3c3hx$ = formUrlEncodeTo_1;
  package$http.formUrlEncodeTo_askgr4$ = formUrlEncodeTo_2;
  ...
  package$http.parametersOf_atu3vi$ = parametersOf_2;
  package$http.parametersOf_cjfssn$ = parametersOf_3;
  ...
  package$http.pathComponents_7buj3i$ = pathComponents;
  package$http.pathComponents_qmwsk$ = pathComponents_0;
  package$http.appendPathSegments_qmwsk$ = appendPathSegments;
  package$http.appendPathSegments_7buj3i$ = appendPathSegments_0;
  package$http.path_7buj3i$ = path;
  package$http.appendEncodedPathSegments_qmwsk$ = appendEncodedPathSegments;
  package$http.appendEncodedPathSegments_7buj3i$ = appendEncodedPathSegments_0;
  ...
  Object.defineProperty(package$http, 'ROOT_PATH_8be2vx$', {
    get: function () {
      return ROOT_PATH;
    }
  });
  ...
  Object.defineProperty(package$content, 'VersionListProperty', {
    get: function () {
  ...
  Object.defineProperty(VersionCheckResult, 'OK', {
    get: VersionCheckResult$OK_getInstance
  });
  Object.defineProperty(VersionCheckResult, 'NOT_MODIFIED', {
    get: VersionCheckResult$NOT_MODIFIED_getInstance
  });
  Object.defineProperty(VersionCheckResult, 'PRECONDITION_FAILED', {
    get: VersionCheckResult$PRECONDITION_FAILED_getInstance
  });
  ...
  Object.defineProperty(EntityTagVersion_0, 'Companion', {
    get: EntityTagVersion$Companion_getInstance
  });
  ...
  Kotlin.defineModule('ktor-ktor-http-js-legacy', _);
  return _;
}));
